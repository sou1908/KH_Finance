...
export function seedState() {
  ...
  return {
    ...
    // The company funds a partner so they can do the buying. Without these the
    // personal accounts would show negative the moment they spent anything.
    transfers: [
      {
        id: 'trf_1',
        date: '2026-04-11',
        amount: 150000,
        fromAccountId: 'acc_company',
        toAccountId: 'acc_personal_a',
        projectId: p1,
        mode: 'IMPS',
        reference: 'HDFC/9931',
        note: 'Advance for electrical + hardware',
        attachments: [],
      },
      {
        id: 'trf_2',
      ...
      },
      {
        ...
        amount: 60000,
        fromAccountId: 'acc_company',
        toAccountId: 'acc_personal_b',
        projectId: p2,
        mode: 'UPI',
        reference: 'UPI/77120',
        note: 'Advance for hardware',
        attachments: [],
      },
    ],
    expenses: [
